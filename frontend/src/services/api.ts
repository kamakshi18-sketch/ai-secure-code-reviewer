...
export const patchesApi = {
  ...
  regenerate: (id: string) => api.post(`/patches/${id}/retry`),
};
...
export const reportsApi = {
  ...
  download: (id: string) => api.getBlob(`/reports/${id}/download`),
...
export const pullRequestsApi = {
  ...
  update: (id: string, data: any) => api.post<any>(`/pull-requests/${id}/update`, data),
